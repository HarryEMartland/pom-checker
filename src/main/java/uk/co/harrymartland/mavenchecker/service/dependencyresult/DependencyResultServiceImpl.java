...
import static uk.co.harrymartland.mavenchecker.domain.result.DependencyDifference.BEHIND;
import static uk.co.harrymartland.mavenchecker.domain.result.DependencyDifference.IGNORED;
import static uk.co.harrymartland.mavenchecker.domain.result.DependencyDifference.MINOR_VERSION_BEHIND;
import static uk.co.harrymartland.mavenchecker.domain.result.DependencyDifference.UP_TO_DATE;
...
import uk.co.harrymartland.mavenchecker.domain.result.DependencyDifference;
